			...
			while ($resultFAQ = mysql_fetch_array($sqlzapros1)){
				...
				<div class =\"".$resultFAQ['id']."\">
					...
					<div class=\"row\" >
						<div class=\"col-sm-12\">
						Ответить</br>
						<textarea id=\"question\" name=\"question\" style=\"width:100%; background-color:#FDF5E6; margin-top:1%;height:50px; margin-left:2%; min-height:10px;resize:none;\"></textarea></br>
